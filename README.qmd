...
gt |>
  ...
  select(table_figure, experiment, arm, model, quantity, value_paper, value_script, match) |>
  kable(
    booktabs = TRUE,
...
gt |>
  ...
  select(experiment, arm, quantity, value_paper, value_rewrite, match_rewrite) |>
  kable(
    booktabs = TRUE,
...
gt |>
  mutate(across(everything(), \(x) replace_na(as.character(x), ""))) |>
  select(table_figure, experiment, arm, model, quantity, value_paper, value_rewrite, match_rewrite) |>
  kable(
    booktabs = TRUE,
